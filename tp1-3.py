...
def valido():
	...
	while contador < 3:
		...
		if contador==3:
			print("Ha superado el límite de intentos. Se va a cerrar el programa.")
...
def gestionnovedades():
	...
	opcionalt=input("Ingrese el número de la sección a la que quiera ingresar:")
...
def gestionlocal():
	...
	opcion2=input("Ingrese el número de la sección a la que quiera ingresar: ")
	while opcion2<"1" or opcion2>"4":
		print("Opción invalida. Vuelva a intentarlo")
		Gestionlocalopciones()
		opcion2=input("Ingrese un número de acuerdo a la opción que quiera seleccionar.")
	if opcion2=="1":
		crearlocal()
	elif opcion2=="4":
		inicio()
